...
class Game {
    ...
    shopHasAffordable() {
        ...
        if (this.state.hearts < MAX_HEARTS && shards >= HEART_COST) return true;
    ...
    updateHeartUI() {
        ...
        const affordable = this.state.shards >= HEART_COST;
    ...
    buyHeart() {
        if (this.state.hearts >= MAX_HEARTS || this.state.shards < HEART_COST) {
            this.shakeUI(this.ui.shopLifeBtn);
            return false;
        }
        this.state.shards -= HEART_COST;
        this.state.hearts++;
